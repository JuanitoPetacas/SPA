                    ...
                    <div class="row g-3 g-md-5">
                        ...
                        <div class="col-12 col-md-6">
                            <form>
                                ...
                                <input type="text" class="form-control form-control-lg rounded-3 mb-1" name="nombres"
                                    id="nombres" required>
                                <label class="text-secondary fs-5 ms-1 mb-1" for="nombres">Apellidos*</label>
                                <input type="text" class="form-control form-control-lg rounded-3 mb-1" name="apellidos"
                                    id="apellidos" required>
                                <label class="text-secondary fs-5 ms-1 mb-1" for="telefono">Teléfono*</label>
                                <input type="tel" class="form-control form-control-lg rounded-3 mb-3" name="telefono"
                                    id="telefono" pattern="^[0-9]*$" required>
                                <h3 class="mb-1">Datos de ingreso</h3>
                                <label class="text-secondary fs-5 ms-1 mb-1" for="email">Email*</label>
                                <input type="email" class="form-control form-control-lg rounded-3 mb-1" name="email"
                                    id="email" required>
                                <label class="text-secondary fs-5 ms-1 mb-1" for="password">Contraseña*</label>
                                <input type="password" class="form-control form-control-lg rounded-3 mb-2" name="password"
                                ...
                                <div class="row">
                                    <div class="col-auto ms-auto">
                                        <button class="btn btn-lg btn-primary px-3" type="button"
                                            id="btnRegistrarme">
                                            Registrarme
                                        </button>
                                    </div>
